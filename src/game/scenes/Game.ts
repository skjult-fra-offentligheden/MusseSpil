...
export class Game extends Phaser.Scene {
  ...
  create() {
    ...
    const cop1Animations = this.anims.get("cop1");;
    console.log('Available animations:', cop1Animations);
  ...
  private createNPCAnimations(standard_npcs_atlas: { textureKey: string, framePrefix: string, idleFrame: string }[]): void {
    ...
    console.log("standard npc atlas " + JSON.stringify(standard_npcs_atlas) ) 
  ...
  private createAnimationForNPC(npcData: {
    ...
    this.anims.create({
      ...
      frames: npcData.leftFrames.map((frameNumber) => {
        let frameName = frameNumber === 0 ? `${npcData.framePrefix}.png` : `${npcData.framePrefix}${frameNumber}.png`;
        return {
  ...
  private createNPCs(collisionLayer: Phaser.Tilemaps.TilemapLayer): void {
    this.npcs = [
    new NPC({scene: this, x: 500, y: 400,texture: 'cop1',frame: 'cop1Sprite.png',dialogues: npcDialogues['cop1'], dialogueManager: this.dialogueManager,
    ...
    new NPC({ scene: this, x: 600, y: 700, texture: 'cop2', frame: 'cop2sprite.png', dialogues: npcDialogues['cop2'], dialogueManager: this.dialogueManager, npcId: 'cop2', 
    ...
    new NPC({scene: this, x: 500, y: 450, texture: "CopGirlSprite", frame: "CopGirlSprite0.png", dialogues: npcDialogues['copGirl'], dialogueManager: this.dialogueManager, npcId: "CopGirlSprite",
    ...
    new NPC({scene: this, x: 1385, y: 700, texture: "fancyMouse", frame: "fancyMouse0.png", dialogues: npcDialogues['placeholderDialogue'], dialogueManager: this.dialogueManager, npcId: "fancyMouse",
    ...
    new NPC({scene: this, x: 1500, y: 1450, texture: "fatMouse", frame: "fatMouse0.png", dialogues: npcDialogues['bluemouse'], dialogueManager: this.dialogueManager, npcId: "fatMouse",
    ...
    new NPC({scene: this, x: 800, y: 1250, texture: "grannyMouse", frame: "grannyMouse0.png", dialogues: npcDialogues['grannymouse'], dialogueManager: this.dialogueManager, npcId: "grannyMouse",
    ...
    new NPC({scene: this, x: 50, y: 2000, texture: "mageMouse", frame: "mageMouse0.png", dialogues: npcDialogues['wizard'], dialogueManager: this.dialogueManager, npcId: "mageMouse",
    ...
    new NPC({scene: this, x: 1600, y: 900, texture: "orangeShirtMouse", frame: "orangeShirtMouse0.png", dialogues: npcDialogues['albino'], dialogueManager: this.dialogueManager, npcId: "orangeShirtMouse",
    ...
    new NPC({scene: this, x: 2000, y: 1300, texture: "pinkDressGirlMouse", frame: "pinkDressGirlMouse0.png", dialogues: npcDialogues['basicmouse'], dialogueManager: this.dialogueManager, npcId: "pinkDressGirlMouse",
    ...
    new NPC({scene: this, x: 2300, y: 2300, texture: "redDressCyborgMouse", frame: "redDressCyborgMouse0.png", dialogues: npcDialogues['placeholderDialogue'], dialogueManager: this.dialogueManager, npcId: "redDressCyborgMouse",
    ...
    new NPC({scene: this, x: 2300, y: 600, texture: "redShirtMouse", frame: "redShirtMouse0.png", dialogues: npcDialogues['placeholderDialogue'], dialogueManager: this.dialogueManager, npcId: "redShirtMouse",
    ...
    new NPC({scene: this, x: 2200, y: 420, texture: "rockerMouse", frame: "rockerMouse0.png", dialogues: npcDialogues['mouseRocker'], dialogueManager: this.dialogueManager, npcId: "rockerMouse",
    ...
    new NPC({scene: this, x: 1500, y: 2300, texture: "sorcerrorMouse", frame: "sorcerrorMouse0.png", dialogues: npcDialogues['placeholderDialogue'], dialogueManager: this.dialogueManager, npcId: "sorcerrorMouse",
    ...
    new NPC({scene: this, x: 1000, y: 1100, texture: "yellowShirtMouse", frame: "yellowShirtMouse0.png", dialogues: npcDialogues['creator'], dialogueManager: this.dialogueManager, npcId: "yellowShirtMouse",
    ...
    new NPC({scene: this, x: 1000, y: 200, texture: "redDressgirlMouse", frame: "redDressgirlMouse0.png", dialogues: npcDialogues['mouseRedDressGirl'], dialogueManager: this.dialogueManager, npcId: "redDressgirlMouse",
  ...
  private createObjects(): void {
    this.Objects = [
      new Body(this, 600, 500, 'deadbody', bodyDialogues['DeadBody'], this.dialogueManager, 'deadbody', undefined, undefined, undefined, undefined, false),
      new Body(
        this,
        600,
        400,
        'knifeBlood',
        bodyDialogues['knifeBlood'],
        this.dialogueManager,
        'knifeBlood',
        'knifeBlood',
        'Bloody Knife',
        'A knife with blood stains. Could this be the murder weapon?',
        'knifeBloodIcon',
        true
      ),
    ...
    const testItems: Item[] = [
      {
        itemId: 'knifeBlood',
        itemName: 'knifeBlood',
        itemDescription: 'Bloody Knife',
        iconKey: 'knifeBloodIcon',
        quantity: 1,
        isClue: true,
      },
      {
        itemId: 'gun',
        itemName: 'Gun',
        itemDescription: 'An old revolver with no bullets.',
        iconKey: 'gun',
        quantity: 1,
        isClue: true,
      },
  ...
  displayBase64Image(base64ImageData: string) {
    // Generate a unique texture key for this image
    const textureKey = 'base64Image';

    // Listen for when the base64 image has been added to the Texture Manager
    this.textures.once('addtexture', (key: string, texture: Phaser.Textures.Texture) => {
      if (key === textureKey) {
        console.log('Texture keys:', this.textures.getTextureKeys());

        // Now that the image is loaded, we can display it
        this.add.image(400, 300, textureKey); // Adjust x and y as needed
      }
    });

    // Add the base64 image to the Texture Manager (asynchronous)
    this.textures.addBase64(textureKey, base64ImageData);
  }
}
